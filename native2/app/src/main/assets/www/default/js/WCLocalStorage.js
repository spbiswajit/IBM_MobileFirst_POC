...
var WCLocalStorageJS = (function() {
	...
	var defaultHostName = "aurora.eperium.nl";
	var defaultStoreId = "10151";
	var defaultStoreName = "sligro";
	var defaultCatalogId = "10101";
	var defaultLangId = "-31";
		...
		initializeSettings: function() {
			...
			WL.Device.getNetworkInfo (function (networkInfo) {
				...
				if (isConnected != null && isConnected == "true" && hostName != null && hostName != "") {
					...
					remoteServerURL = remoteServerURL.replace("/en/", "/nl/");
