...
function setSystemLocaleTr_TR() {
	LocalizedClientMessages.close = "Kapat";
	LocalizedClientMessages.directUpdateNotificationTitle = "Güncelleme Var";
	LocalizedClientMessages.directUpdateNotificationMessage = "Uygulama için bir güncelleme var (dosya büyüklüğü {0} MB).";
	LocalizedClientMessages.directUpdateErrorTitle = "Güncelleme Başarısız Oldu",
	LocalizedClientMessages.directUpdateErrorMessageNotEnoughStorage = "Uygulama için bir güncelleme var, ancak aygıtta yeterli yer yok (gereken büyüklük: {0} MB, kullanılabilecek yer: {1} MB).";
	LocalizedClientMessages.directUpdateErrorMessageFailedDownloadingZipFile = "Uygulama güncelleme dosyası karşıdan yüklenemedi.";
	LocalizedClientMessages.directUpdateErrorMessageFailedProcessingZipFile = "Uygulama güncelleme dosyası işlenemedi.";
	LocalizedClientMessages.loading = "Yükleniyor";
	LocalizedClientMessages.reload = "Yeniden Yükle";
	LocalizedClientMessages.tryAgain = "Yeniden Dene";
	LocalizedClientMessages.update = "Güncelle";
	LocalizedClientMessages.wlSettings = "Worklight Ayarları";
};
